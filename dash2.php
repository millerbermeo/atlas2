...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <form action="" id="formulario" style="margin-bottom: 30px;">
            <div class="mb-3">
                <label for="fecha" class="form-label fw-bold" style="margin-bottom: 8px;">Selecciona Año y Mes:</label>
       ...
       <table class="table table-striped shadow border">
            <thead style="background-color: #222d32; color: white;">
                <tr>
                    ...
                    <th scope="col">Total Campañas</th>
                    <th scope="col">Llamadas Completadas</th>
