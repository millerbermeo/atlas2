document.addEventListener('DOMContentLoaded', function () {
    ...
    const apiUrlPost = 'https://172.16.1.27:8734/dashboard/table_sms.php';
        ...
        fetch(apiUrlPost, {
            ...
            .then(data => {
                ...
                data.forEach((item, index) => {
                    ...
                    // Asegurarse de que las claves que obtienes coincidan con las que esperas, incluyendo el índice
                    const keys = ['index', 'anio_mes_envio', 'usuario', 'status', 'cantidad', 'distintos_name_campana'];
